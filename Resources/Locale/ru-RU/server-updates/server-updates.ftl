server-updates-received = Сеть «Ядерный Рассол» получила обновление. Сервер будет автоматически перезапущен в конце этого раунда для применения новых инструкций.

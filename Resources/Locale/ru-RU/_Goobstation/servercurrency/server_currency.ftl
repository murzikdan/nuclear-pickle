server-currency-name-singular = Рассол Коин
server-currency-name-plural = Рассол Коины
...
gs-balanceui-shop-label = Магазин Рассола
...
gs-balanceui-shop-buy-token-hightier-antag = Купить хайтир антаг токен - { $price } Рассол Коинов
gs-balanceui-shop-buy-token-midtier-antag = Купить мидтир антаг токен - { $price } Рассол Коинов
gs-balanceui-shop-buy-token-admin = Купить должность младшего игрового модератора - { $price } Рассол Коинов
gs-balanceui-shop-buy-token-antag = Купить антаг токен - { $price } Рассол Коинов
gs-balanceui-shop-buy-token-lowtier-antag = Купить лоутир - { $price } Рассол Коинов
gs-balanceui-shop-buy-token-hat = Купить токен на шляпу - { $price } Рассол Коинов
gs-balanceui-shop-token-admin = Младший игровой модератор
gs-balanceui-shop-token-antag = Хайтир антаг токен
gs-balanceui-shop-buy-token-admin-abuse = Купить админ абуз токен - { $price } Рассол Коинов
...
gs-balanceui-shop-buy-token-ghost = Купить гостроль токен - { $price } Рассол Коинов
...
gs-balanceui-remark-token-hightier-antag = Купил хайтир антаг токен. (удалите заметку после выдачи)
gs-balanceui-remark-token-midtier-antag = Купил мидтир антаг токен. (удалите заметку после выдачи)
gs-balanceui-remark-token-ghost = Купил гостроль токен. (удалите заметку после выдачи)
gs-balanceui-remark-token-lowtier-antag = Купил ловтир антаг токен. (удалите заметку после выдачи)
gs-balanceui-remark-token-admin-abuse = Купил админ абуз токен. (удалите заметку после выдачи)
